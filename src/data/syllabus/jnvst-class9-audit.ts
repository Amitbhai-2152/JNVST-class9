...
const aliases: Record<string, string[]> = {
  ...
  'sci_13': ['प्रकाश'],
  'sci_14': ['संश्लेषित रेशे और प्लास्टिक'],
  'sci_15': ['धातु और अधातु'],
  'sci_16': ['कोशिका - संरचना एवं प्रकार्य'],
  'sci_17': ['तारे एवं सौर परिवार'],
  'sci_18': ['वायु तथा जल का प्रदूषण'],
  ...
  'hin_01': ['वर्ण विचार / वर्तनी विवेक'],
