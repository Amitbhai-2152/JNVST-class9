...
const mathLessonContent: Record<string, ContentBlock[]> = {
  ...
  top_math_02_01: c([
    ...
    { type: 'formula', expression: '$$y\\propto x\\Rightarrow\\frac{y}{x}=\\text{स्थिर}$$' },
    { type: 'formula', expression: '$$y\\propto\\frac1x\\Rightarrow xy=\\text{स्थिर}$$' },
  ...
  top_math_02_02: c([
    ...
    { type: 'formula', expression: '$$प्रतिशत=\\frac{भाग}{पूर्ण\\ राशि}\\times100$$' },
    { type: 'heading', level: 3, text: 'लाभ, हानि और छूट' },
    { type: 'formula', expression: '$$लाभ=SP-CP,\\quad लाभ\\%=\\frac{लाभ}{CP}\\times100$$' },
    { type: 'formula', expression: '$$हानि=CP-SP,\\quad हानि\\%=\\frac{हानि}{CP}\\times100$$' },
    { type: 'formula', expression: '$$छूट=MP-SP,\\quad छूट\\%=\\frac{छूट}{MP}\\times100$$' },
  ...
  top_math_04_02: c([
    ...
    { type: 'formula', expression: '$$आयत\\ का\\ क्षेत्रफल=l\\times b,\\quad परिमाप=2(l+b)$$' },
    { type: 'formula', expression: '$$वर्ग\\ का\\ क्षेत्रफल=a^2,\\quad परिमाप=4a$$' },
    { type: 'formula', expression: '$$त्रिभुज\\ का\\ क्षेत्रफल=\\frac12bh$$' },
    { type: 'formula', expression: '$$समांतर\\ चतुर्भुज\\ का\\ क्षेत्रफल=bh$$' },
    { type: 'formula', expression: '$$समचतुर्भुज\\ का\\ क्षेत्रफल=\\frac12d_1d_2$$' },
    { type: 'heading', level: 3, text: 'घन और घनाभ' },
    { type: 'formula', expression: '$$घनाभ\\ का\\ आयतन=lbh$$' },
    { type: 'formula', expression: '$$घनाभ\\ का\\ सम्पूर्ण\\ पृष्ठीय\\ क्षेत्रफल=2(lb+bh+hl)$$' },
    { type: 'formula', expression: '$$घन\\ का\\ आयतन=a^3,\\quad सम्पूर्ण\\ पृष्ठीय\\ क्षेत्रफल=6a^2$$' },
    { type: 'heading', level: 3, text: 'बेलन' },
    { type: 'formula', expression: '$$बेलन\\ का\\ आयतन=\\pi r^2h,\\quad वक्र\\ पृष्ठीय\\ क्षेत्रफल=2\\pi rh$$' },
    { type: 'heading', level: 3, text: 'हल किया हुआ उदाहरण' },
  ...
  top_math_05_01: c([
    ...
    { type: 'formula', expression: '$$श्रेणी\\ का\\ मान=\\frac{केंद्रीय\\ कोण}{360^\\circ}\\timesकुल\\ मान$$' },
    { type: 'heading', level: 3, text: 'माध्य' },
    { type: 'formula', expression: '$$माध्य=\\frac{सभी\\ प्रेक्षणों\\ का\\ योग}{प्रेक्षणों\\ की\\ संख्या}$$' },
    { type: 'heading', level: 3, text: 'हल किया हुआ उदाहरण' },
  ...
  top_math_05_01_probability: c([
    ...
    { type: 'formula', expression: '$$P(E)=\\frac{अनुकूल\\ परिणामों\\ की\\ संख्या}{कुल\\ समान\\ संभावित\\ परिणामों\\ की\\ संख्या}$$' },
    ...
    { type: 'formula', expression: '$$P(घटना\\ न\\ होने\\ की\\ संभावना)=1-P(घटना)$$' },
