...
import { hindiExpansionQuestions } from "./hindiExpansion";
...
export const hindiQuestionBank: Question[] = [...hindiQuestions, ...hindiExpansionQuestions];
...
const counts = {
  ...
  sub_hin: hindiQuestionBank.length,
  sub_math: mathQuestions.length,
  sub_sci: scienceQuestions.length,
};

const expectedCounts = { sub_eng: 150, sub_hin: 165, sub_math: 220, sub_sci: 360, total: 895 };
