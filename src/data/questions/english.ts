...
const englishQuestionsBatch2: Question[] = [
  ...
  createQuestion({ id: 'q_eng_b2_09_005', type: 'mcq', subjectId: 'sub_eng', chapterId: 'chap_eng_04', topicId: 'top_eng_04_02', textPlain: "The teacher said to the students, 'Do not waste water.' Change this to reported speech.", options: [{ id: 'opt_1', text: 'The teacher advised the students not to waste water.' }, { id: 'opt_2', text: 'The teacher advised the students to not wasted water.' }, { id: 'opt_3', text: 'The teacher said the students do not waste water.' }, { id: 'opt_4', text: 'The teacher told that the students not waste water.' }], correctOptionIds: ['opt_1'], explanationPlain: 'A negative imperative is commonly reported with advised + object + not to + verb.', difficulty: 'challenge', tags: ['reported-speech', 'negative-imperative'] }),
  ...
  createQuestion({ id: 'q_eng_b2_10_005', type: 'mcq', subjectId: 'sub_eng', chapterId: 'chap_eng_04', topicId: 'top_eng_04_03', textPlain: 'Choose the sentence that correctly uses a superlative adjective to compare members of a group.', options: [{ id: 'opt_1', text: 'Riya is the tallest of the three sisters.' }, { id: 'opt_2', text: 'Riya is taller of the three sisters.' }, { id: 'opt_3', text: 'Riya is the taller among the three sisters.' }, { id: 'opt_4', text: 'Riya is most tall than her two sisters.' }], correctOptionIds: ['opt_1'], explanationPlain: 'When one person has the highest degree of a quality within a group, use the superlative form with the definite article: the tallest of the three sisters.', difficulty: 'hard', tags: ['degrees-of-comparison', 'superlative', 'group-comparison'] })
];
